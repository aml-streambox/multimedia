...
// TBDR-optimized P010 Y output with 3D LUT HDR conversion.
//
// Each fragment maps to one luma pixel in the source.
//   1. Computes source pixel coords from gl_FragCoord
//   2. Reads AMLY pair from SSBO, applies bswap64 correction
//   3. Extracts Y0 or Y1 depending on even/odd x
//   4. If HDR mode: extracts Cb/Cr, normalizes, samples 3D LUT
