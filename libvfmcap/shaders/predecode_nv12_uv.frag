...
// NV12 UV output from pre-decoded intermediates with 3D LUT HDR conversion.
//
// Same as predecode_p010_uv.frag but output is R8G8_UNORM.
//
...
void main() {
    ...
    if (params.color_mode == 0u) {
        // Passthrough: R16G16 -> R8G8 natural truncation
        out_uv = uv_raw;
    } else {
        // HDR->SDR via 3D LUT
