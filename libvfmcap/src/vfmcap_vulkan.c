                             ...
                             uint32_t hdr_mode)
{
     ...
     * NV12: local_size=(128,1,1), 2 pairs/thread, 1 row/workgroup
     *       tile = 256 pairs, groups_x = ceil(pairs_per_row/256), groups_y = height
     */
    ...
    if (fmt == VFMCAP_VK_FMT_P010) {
        ...
        groups_x = (pairs_per_row + 255) / 256;
        groups_y = height;
    }
