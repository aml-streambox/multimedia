...
/**
 * vfmcap_vk_render_afbc_nv12_and_wait - Render to AFBC NV12 output (8-bit input)
 */
...
/**
 * vfmcap_vk_render_10bit_afbc_nv12_and_wait - Render AMLY to AFBC NV12 output (10-bit input)
 */
